...
pub(crate) fn eval_metrics<'a>(
    ...
    let value = match field {
        ...
        "text.last_line_length" => metrics.text.as_ref().map(|t| t.last_line_length as f64),
        "text.lines_over_1000" => metrics.text.as_ref().map(|t| t.lines_over_1000 as f64),
        "text.total_lines" => metrics.text.as_ref().map(|t| t.total_lines as f64),
        "text.invisible_chars" => metrics.text.as_ref().map(|t| t.invisible_chars as f64),
